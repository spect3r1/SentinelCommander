...
typedef enum _SYSTEM_INFORMATION_CLASS {
  ...
  SystemWatchdogTimerHandler,     // s: SYSTEM_WATCHDOG_HANDLER_INFORMATION //
                                  // (kernel-mode only)
  SystemWatchdogTimerInformation, // q: SYSTEM_WATCHDOG_TIMER_INFORMATION //
                                  // (kernel-mode only)
  ...
  SystemSpecialPoolInformation,      // q; s: SYSTEM_SPECIAL_POOL_INFORMATION
                                     // (requires SeDebugPrivilege) //
  ...
  SystemTimeZoneInformation,        // q; s: RTL_TIME_ZONE_INFORMATION (requires
                                    // SeTimeZonePrivilege)
  SystemImageFileExecutionOptionsInformation, // s:
                                              // SYSTEM_IMAGE_FILE_EXECUTION_OPTIONS_INFORMATION
                                              // (requires SeTcbPrivilege)
  SystemCoverageInformation, // q: COVERAGE_MODULES s: COVERAGE_MODULE_REQUEST
  ...
  SystemDynamicTimeZoneInformation,   // q; s: RTL_DYNAMIC_TIME_ZONE_INFORMATION
  ...
  SystemProcessorBrandString,      // q: CHAR[] // HaliQuerySystemInformation ->
  ...
  SystemLogicalProcessorAndGroupInformation, // q:
                                             ...
                                             // RelationshipType) // since WIN7
                                             // //
                                             // KeQueryLogicalProcessorRelationship
  SystemProcessorCycleTimeInformation, // q:
                                       // SYSTEM_PROCESSOR_CYCLE_TIME_INFORMATION[]
                                       // (EX in: USHORT ProcessorGroup)
  SystemStoreInformation,     // q; s: SYSTEM_STORE_INFORMATION (requires
  ...
  SystemProcessorCycleStatsInformation, // q:
                                        ...
                                        // (EX in: USHORT ProcessorGroup) // 160
  SystemVmGenerationCountInformation,
  SystemTrustedPlatformModuleInformation, // q: SYSTEM_TPM_INFORMATION
  SystemKernelDebuggerFlags,              // SYSTEM_KERNEL_DEBUGGER_FLAGS
  SystemCodeIntegrityPolicyInformation,   // q; s:
  ...
  SystemVsmProtectionInformation, // q: SYSTEM_VSM_PROTECTION_INFORMATION
                                  // (previously SystemDmaProtectionInformation)
  ...
  SystemAffinitizedInterruptProcessorInformation, // (requires
                                                  // SeIncreaseBasePriorityPrivilege)
  ...
  SystemProcessorIdleMaskInformation, // q: ULONG_PTR[ActiveGroupCount] // since
                                      // REDSTONE3
  ...
  SystemFirmwarePartitionInformation,  // SYSTEM_FIRMWARE_PARTITION_INFORMATION
                                       // // 200
  ...
  SystemSecurityModelInformation, // SYSTEM_SECURITY_MODEL_INFORMATION // since
                                  // 19H1
  ...
  SystemPoolLimitInformation, // SYSTEM_POOL_LIMIT_INFORMATION (requires
                              // SeIncreaseQuotaPrivilege)
